<?php
/*
A classe database ira permitir a comunicacao com o banco de dados.
...
E uma variável para a conexao com o banco que será usada em outros arquivos
e, portanto, será declarada com o modificador  public
*/ 
class Database{
