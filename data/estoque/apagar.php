...
if(!empty($data->id)){
    ...
    if($estoque->Apagar()){
        ...
        header("HTTP/1.0 400");
        echo json_encode(array("mensagem"=>"Não foi possivel apagar estoque."));
    }
}
else{
    header("HTTP/1.0 400");
    echo json_encode(array("mensagem"=>"Voce precisa passar todos os dados para apagar o estoque"));
}
