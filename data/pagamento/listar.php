...
Isso fará com que todas as funcoes que estão dentro da classe pagamento sejam 
...
uma consulta no formato sql que selecionada todos os usuário("Select * from pagamento")  
*/
...
construido um array com os dados dos pagamento.
Caso contrário será exibido uma mensagem que não pagamento cadastrados 
*/ 

if($stmt->rowCount() > 0){

 /* 
Para organizar os pagamento cadastrados em banco e exibi-los em tela, foi 
criada uma array com o nome de saida e assim guardar todos pagamento.  
 */ 

$pagamento_arr = array();
/* 
A estrutura while(enquanto) realizar a busca e todos os pagamento 
...
while($linha = $stmt->fetch(PDO::FETCH_ASSOC)){
    ...
    array de itens, pois será assim que os pagamento serão tratado,
    ...
    */ 
    ...
    Assim estamos adicionando ao pagamento_arr[saido] um item
    que é um pagamento com seus respectivo dados.  
    */ 
    ...
    */ 
    ...
    a mensagem "mensagem: Não há pagamento cadastrados " que será mostrada por meio 
    de jason_encode 
    */ 
    header("HTTP/1.0 400");
