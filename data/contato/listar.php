...
Isso fará com que todas as funcoes que estão dentro da classe Contato sejam 
...
uma consulta no formato sql que selecionada todos os usuário("Select * from contato")  
*/
...
construido um array com os dados dos contato.
Caso contrário será exibido uma mensagem que não contato cadastrados 
*/ 

if($stmt->rowCount() > 0){

 /* 
Para organizar os contato cadastrados em banco e exibi-los em tela, foi 
criada uma array com o nome de saida e assim guardar todos contato.  
 */ 

$contato_arr = array();
/* 
A estrutura while(enquanto) realizar a busca e todos os contato 
...
while($linha = $stmt->fetch(PDO::FETCH_ASSOC)){
    ...
    array de itens, pois será assim que os contato serão tratado,
    ...
    */ 
    ...
    Assim estamos adicionando ao contato_arr[saido] um item
    que é um contato com seus respectivo dados.  
    */ 
    ...
    */ 
    ...
    a mensagem "mensagem: Não há contato cadastrados " que será mostrada por meio 
    de jason_encode 
    */ 
    header("HTTP/1.0 400");
